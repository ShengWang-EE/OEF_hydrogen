function [g] = consfcn_electricPowerBalance_AC(Va,Vm,Pg,Qg, Pptg, mpc,nPTG)
...
if mpopt.opf.v_cartesian
    ...
    Sbus = makeSbus_yalmip(baseMVA, bus, gen, Pg, Qg, mpopt, Vm);  %% net injected power in p.u.
end
...
for i = 1:nPTG
  EBindex = mpc.ptg(i,2);
  mis(EBindex) = mis(EBindex) - Pptg(i); %待定，应该是负荷为正？
end
